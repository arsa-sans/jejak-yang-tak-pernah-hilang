const paragraphs = [
  ...
  `Karena sejatinya, kitab itu tidak berada di ujung pencarian, tapi ada di sepanjang perjalanan. Dan tugas kalian kali ini adalah temukan kitab itu di tempat yang tersembunyi, tempat yang hanya bisa ditemukan ketika kalian bisa memahami semua clue yang didapatkan. Perjalanan kalian belum selesai. Selamat mencari.`
];
    const ANGKA = '2359';
    const TYPE_SPEED = 50;
